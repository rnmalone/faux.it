...
export default async function createEmployeeSaleStatusPie(connection: Connection, employeeId: number, { dateFrom, dateTo }: IDateRange): Promise<EmployeeSaleStatusPie> {
